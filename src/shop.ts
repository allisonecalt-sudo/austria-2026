...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    status: 'ingr',
    misrachi: '',
    why: 'Your rav: ok according to most - potato, oil, salt',
  ...
  },
  {
    ...
    status: 'ingr',
    misrachi: '',
    why: 'Your rav: ok according to most - corn, oil, salt',
  ...
  },
  {
    ...
    status: 'ingr',
    misrachi: '',
    why: 'Your rav: room to be lenient - steamed first, not kings-table, made industrially. Still read the can',
    ingredients: '',
  },
  {
  ...
  },
  {
    ...
    status: 'ingr',
    misrachi: '',
    why: 'Your rav: ok - cold-smoked, never actually cooked. Kosher species (fins + scales)',
    ingredients: '',
  },
  {
    slug: 'rauch-orange',
