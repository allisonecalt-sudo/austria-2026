...
const WEEK: CDay[] = [
  {
    ...
    steps: [
      ...
      {
        t: '11:30',
        text: 'Mauthausen Memorial — ~3 hours with the audio guide. Free. Heavy and worth it.',
        actId: 'mauthausen',
      },
    ...
    sunset:
      'From the apartment / riverside stroll (~20:50) — no driving needed, Shabbat has begun.',
  ...
  },
  {
    ...
    steps: [
      ...
      {
        t: '21:45',
        text: 'Havdalah → pack the day-bag for Sunday, book nothing, sleep early-ish.',
      },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      {
        t: '09:00',
        text: 'SchafbergBahn steam train up (RESERVED seats — book by Wed!). Three lakes at your feet.',
        actId: 'schafberg',
      },
      {
        t: '11:30',
        text: 'Back down → rent a little e-boat in St. Gilgen (€35/h, swim ladder — no reservation) OR ferry hop + Strandbad swim + picnic.',
        actId: 'wolfgangsee-eboat',
      },
      {
        t: '15:00',
        text: 'Drive 1h15 to Zell am See, check in der Sonnberg (17:00–18:00 window).',
      },
      { t: '18:30', text: 'Walk down to the lake — first look at your new water.' },
      {
        t: '20:53',
        text: '🌅 Esplanade sunset — peaks going pink over the Zeller See.',
        actId: 'strandbad-zell',
      },
    ],
  ...
  },
  {
    ...
    steps: [
      {
        t: '08:30',
        text: 'Kitzsteinhorn lifts up to 3,029 m — July snow, Top of Salzburg platform. Layers ON.',
        actId: 'kitzsteinhorn',
      },
      {
        t: '12:30',
        text: 'Down to the valley → Sigmund-Thun gorge boardwalk + Klammsee loop (~1h, cool mist).',
        actId: 'sigmund-thun',
      },
      {
        t: '15:30',
        text: 'Strandbad Zell: swim, lawn, nap. The slow shoulder.',
        actId: 'strandbad-zell',
      },
      {
        t: '19:45',
        text: '⛵ Board the sunset cruise at the Esplanade pier.',
        actId: 'zell-cruise',
      },
  ...
  },
  {
    ...
    steps: [
      {
        t: '08:45',
        text: 'Mooserboden high dams (20 min away): bus + inclined lift to 2,040 m, flat dam-crown walks between glaciers.',
        actId: 'mooserboden',
      },
      { t: '12:30', text: 'Pack out of Zell → drive toward Gosau via Bad Ischl.' },
      {
        t: '13:45',
        text: 'Bad Ischl: Spar restock + the 30-min “Jewish Ischl” pins walk + a river café stop.',
        actId: 'jewish-ischl',
      },
      { t: '16:00', text: 'Check in Transylvania Villa, Gosau. Unload the cooler.' },
      {
        t: '17:00',
        text: '🛶 One hour in an e-boat or on a SUP ON the Gosausee (rentals till 18:00) — float inside the reflection.',
        actId: 'gosausee-boats',
      },
      {
        t: '18:30',
        text: '🪞 Then the shore loop — the Dachstein doubled in still water, buses gone, nearly alone.',
        actId: 'gosausee',
      },
  ...
  },
  {
    ...
    steps: [
      {
        t: '08:15',
        text: 'Krippenstein gondola at opening (30 min away) → easy stroll to 5 Fingers, platform to yourselves.',
        actId: 'krippenstein',
      },
      {
        t: '12:00',
        text: 'Down → Langbathsee (45 min): flat shore loop, swim, picnic, naps in the grass.',
        actId: 'langbathsee',
      },
      {
        t: '16:30',
        text: 'Hallstatt as the buses leave: market square, swan harbor, rent the little e-boat (~€25/h).',
        actId: 'hallstatt',
      },
      {
        t: '20:30',
        text: '🌅 West-shore pullouts — Hallstatt’s lights come on across the water.',
        actId: 'hallstatt',
      },
    ],
  ...
  },
  {
    ...
    steps: [
      {
        t: '08:15',
        text: 'Check out Gosau → 1h06 to Schönau. Luggage rides along — zero backtracking.',
      },
      {
        t: '09:45',
        text: 'Silent electric boat down the Königssee — trumpet echo at the cliff wall.',
        actId: 'koenigssee',
      },
      { t: '11:00', text: 'St. Bartholomä chapel stop → boat on to Salet.' },
      {
        t: '12:00',
        text: 'Flat 15-min walk to the Obersee: the stillest water of the trip, Röthbach falls on the far cliff. Picnic here.',
        actId: 'koenigssee',
      },
      {
        t: '16:00',
        text: 'Last boat back (CALL AHEAD for the exact last-Salet time) → Hintersee + Zauberwald golden-hour stop, 15 min away.',
        actId: 'hintersee-ramsau',
      },
      {
        t: '19:45',
        text: 'Rossfeld panorama road: drive to the ridge (€9.50), step out.',
        actId: 'rossfeld',
      },
...
function render(): void {
  ...
  const ht = el('div', 'ht');
  ht.appendChild(
    el('p', 'kick', 'my committed pick · smart-busy · full of adventure · nothing strenuous'),
  );
