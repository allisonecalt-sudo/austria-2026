  ...
  days: [
    {
      ...
      blocks: [
        ...
        { icon: 'food', line: 'Spar groceries done by ~11:00, then nap' },
        {
          icon: 'sunset',
    ...
    },
    {
      ...
      blocks: [
        { icon: 'time', line: 'Shacharit at Chabad ~09:30, long lunch, nap' },
        {
          icon: 'activity',
        ...
        { icon: 'sunset', line: 'Sunset from the Salzach river bank · 20:54' },
    ...
    },
    {
      ...
      blocks: [
        { icon: 'drive', line: 'Salzburg → Zell am See ~1h20 (Salzach valley B311)' },
        { icon: 'stay', line: 'Check in der Sonnberg Alpinlodges 17:00–18:00 (self check-in)' },
        {
          icon: 'activity',
    ...
    },
    {
      ...
      dayOfWeek: 'Monday',
      title: 'Full day at Zell am See — peaks, glacier, or waterfalls',
      logistics: 'Base day · pick one big thing',
      photo: P.alpineSunset,
      tldr: 'The full day at the alpine base. Pick one: an easy cable-car panorama, a glacier at 3,029 m with snow in July, or Austria’s tallest waterfalls. Evening swim + sunset back on the lake.',
      blocks: [
        {
          icon: 'activity',
          line: 'Pick one big thing',
          detail:
            'Recommendations, not orders: (1) Schmittenhöhe cable car — 1,965 m panorama deck over the lake, easy half-day. (2) Kitzsteinhorn glacier at Kaprun — gondola to 3,029 m, snow + 360° Hohe Tauern view, ~25-min drive. (3) Krimml Waterfalls — Austria’s tallest at 380 m, three-tier walk-up, ~1h10 west, full day.',
        },
        {
          icon: 'activity',
          line: 'Low-energy version: stay in Zell',
          detail: 'Slow morning, Strandbad swim at the lake lido, café on the Esplanade, sunset right out the door.',
        },
        { icon: 'food', line: 'Evening swim from the Strandbad if it’s warm' },
        { icon: 'sunset', line: 'Sunset on the Esplanade · 20:52' },
      ],
      baseId: 'zell',
    },
    {
      ...
      blocks: [
        { icon: 'drive', line: 'Zell am See → Gosau ~1h45 (Tauern A10 + B166)' },
        { icon: 'food', line: 'Bad Ischl mid-route — Spar restock + café break ~11:30' },
        { icon: 'stay', line: 'Check in Transylvania Villa & Spa 16:00–21:00' },
        {
          icon: 'activity',
    ...
    },
    {
      ...
      dayOfWeek: 'Wednesday',
      title: 'Full day from Gosau — Hallstatt, Krippenstein, or deeper Gosausee',
      logistics: 'Base day · everything is < 25 min away',
      photo: P.hallstattLake,
      tldr: 'The full Salzkammergut day — almost everything in the cluster is under 25 minutes from Gosau. Pick Hallstatt + its Skywalk, the Dachstein-Krippenstein 5 Fingers cable car, or a deeper Gosausee hike. Sunset on the mirror lake or a Hallstatt viewpoint.',
      blocks: [
        {
          icon: 'activity',
          line: 'Pick one day-trip',
          detail:
            'Recommendations, not orders: (1) Hallstatt Markt ~20 min — Skywalk funicular for the 360° view, lakeside promenade. (2) Dachstein-Krippenstein at Obertraun ~25 min — gondolas to 2,109 m for the 5 Fingers cantilevered platform (the famous photo). (3) Hinterer Gosausee — walk to the dramatic back-of-valley view (longer, harder terrain).',
        },
        {
          icon: 'activity',
          line: 'Low-energy day: stay near Gosau',
          detail: 'Slow morning, balcony coffee, a second loop around the Vorderer Gosausee, café in Gosau village.',
        },
        { icon: 'sunset', line: 'Sunset at the Gosausee or a Hallstatt viewpoint · 20:50' },
      ],
      baseId: 'gosau',
    },
    {
      ...
      blocks: [
        { icon: 'drive', line: 'Gosau → Salzburg airport area ~1h20 (B166 + A1)' },
        { icon: 'stay', line: 'Check in Best Western am Walserberg ~13:00' },
        {
          icon: 'activity',
          line: 'Open afternoon — pick from',
          detail:
            'Lazy day at the hotel / Mönchsberg ridge sunset from Toscaninihof / Eisriesenwelt ice cave at Werfen (world’s largest, 75-min underground tour — book the night before, July sells out).',
        },
        {
          icon: 'drive',
        ...
        { icon: 'sunset', line: 'Sunset from the Mönchsberg ridge · 20:47' },
      ],
      baseId: 'airport',
    },
    {
      ...
      blocks: [
        { icon: 'time', line: 'Wake 05:30 · drive to SZG + drop car 06:30' },
